...
function Project({name,des,t1,t2,t3,t4,t5}) {
  return (
    <div className="border border-gray-800 rounded-xl bg-gray-900/50 backdrop-blur-sm p-8 hover:border-green-500/50 transition-all duration-300 transform hover:scale-105 overflow-hidden group mt-10">
      <div className="h-48 bg-gradient-to-br from-green-400/20 to-emerald-600/20 flex items-center justify-content border-b border-gray-800"></div>
      <div className="p-6">
        <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-green-400 transition-colors">{name}</h3>
